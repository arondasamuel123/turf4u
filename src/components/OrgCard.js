...
const OrgCard = ({id, contactNumber, orgEmail, orgLocation, orgName}) => {
    return (
        <div className="max-w-sm bg-teal-100 rounded-lg overflow-hidden shadow-lg mb-8 mr-8">
            <img className=" pt-5 w-full" src={organization} alt="organization_profile"/>
            ...
            <p className="text-gray-500 text-base py-1 px-10">Phone Number:<span className="ml-3 font-normal text-teal-800">{contactNumber}</span></p>
